function [new_a, new_b, new_Sigma_theta] = importance_gradient_descent(u, ra, rb, rsigma, mu_i, sig_i, lr, S, M, maxiter, beta_1, beta_2)
    ...
    while iter <= maxiter
        ...
        d_temp = sqrt(diag(diag(new_Sigma_theta)));  
        new_Sigma_theta = inv(d_temp) * new_Sigma_theta * inv(d_temp);      
